...
class QModule(nn.Module):
    ...
    def _quantize_weight(self, weight):
        ...
        if self._quantized and self._w_bit > 0:   
            ...
            if weight.shape[1] == 3 or weight.shape[0] == 100:
                dsp_bit = 8
            else:
                dsp_bit = 4   
            ...
            if self._calibrate:
                ...
                for (idx, channel) in enumerate(weight):        
                    # if (self._w_bit < 8 and self.channel_type[idx] == 1) or (self.channel_type[idx] == 0 and dsp_bit == 4):
