...
class LinearQuantizeEnv:
    ...
    def _build_state_embedding(self):
        # measure model for cifar 224x32 input
        if self.is_imagenet:
...
def cal_dsp(i, ratio):
    ...
    marray = [12544, 3136, 3136, 3136, 3136, 784, 784, 784, 784, 784, 196, 196, 196, 196, 196, 49, 49, 49, 49, 49, 49, 1]
    karray = [147, 576, 576, 576, 576, 576, 1152, 64, 1152, 1152, 1152, 2304, 128, 2304, 2304, 2304, 4608, 256, 4608, 4608, 512, 512]
    narray = [64, 64, 64, 64, 64, 128, 128, 128, 128, 128, 256, 256, 256, 256, 256, 512, 512, 512, 512, 512, 512, 1000]
    ...
    # narray = [32, 32, 16, 96, 96, 24, 144, 144, 24, 144, 144, 32, 192, 192, 32, 192, 192, 32, 192, 192, 64, 384, 384, 64, 384, 384, 64, 384, 384, 64, 384, 384, 96, 576, 576, 96, 576, 576, 96, 576, 576, 160, 960, 960, 160, 960, 960, 160, 960, 960, 320, 1280, 1000]
    # felog = 3
    ...
    LatencyLiteR = tiles_k * (region_l + (OutputChannel / Dr_Num)) * last_iters_r + readLatencyL + readLatencyR
