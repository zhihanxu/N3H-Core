...
from lib.utils.quantize_utils_new import QConv2d, QLinear, calibrate
...
class LinearQuantizeEnv:
    ...
    def step(self, action):
        ...
        if self.action_radio_button == 1:   #weight
            ...
            self.last_activation_action = self.last_weight_action
        else:
        ...
        if self._is_final_layer() and (self.action_radio_button == -1): #ratio:-1    1 0 -1
            ...
            self.model = calibrate(self.model, self.train_loader)   #calibrate the model with quantization
