...
from lib.utils.quantize_utils_rand import QConv2d, QLinear, calibrate
...
class LinearQuantizeEnv:
    ...
    def step(self, action):
        ...
        if self.action_radio_button == 1:   #weight
            ...
            self.last_ratio_action = round(float(action),3) #ratio
    ...
    def _final_action_wall(self):
        ...
        for i, n_bit in enumerate(self.strategy):
            min_cost += self.cost_lookuptable[i][int(self.min_bit-1)][int(self.min_bit-1)]  #min_bit = 2
