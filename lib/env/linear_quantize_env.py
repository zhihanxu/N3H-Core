...
class LinearQuantizeEnv:
    ...
    def step(self, action):
        ...
        if self._is_final_layer() and (not self.action_radio_button):
            ...
            self.model = calibrate(self.model, self.val_loader)   #calibrate
        ...
        self.layer_embedding[self.cur_ind][-1] = float(self.action_radio_button)    #weight 1 output 0
    ...
    def _min_cost(self):
        min_cost = 0
        for i in range(50):
            if i == 0 or i == 53: #(len(self.strategy) - 1)
