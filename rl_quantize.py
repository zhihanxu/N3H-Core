...
def train(num_episode, agent, env, output, linear_quantization=False, debug=False):
    ...
    while episode < num_episode:  # counting based on episode
        ...
        observation2, reward, done, info = env.step(action)     #environment.step
        ...
        if done:  # end of episode
            ...
            for i, (r_t, s_t, s_t1, a_t, done) in enumerate(T):
                ...
                if episode > args.warmup:       #default:20
...
if __name__ == "__main__":
    ...
    # Architecture
    parser.add_argument('--arch', '-a', metavar='ARCH', default='mobilenetv2', choices=model_names,
                    help='model architecture:' + ' | '.join(model_names) + ' (default: mobilenetv2)')
    ...
    if args.dataset == 'imagenet':
        num_classes = 1000
    elif args.dataset == 'cifar10' or 'cifar10-res':
        num_classes = 10
    else:
    ...
    if not args.customize:
      ...
      model = customized_models.__dict__[args.arch](pretrained=True)
