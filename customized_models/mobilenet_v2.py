...
from lib.utils.quantize_utils import QConv2d, QLinear, QModule, calibrate
...
class ConvBNActivation(nn.Sequential):
    def __init__(
        ...
        super(ConvBNReLU, self).__init__(
            QConv2d(in_planes, out_planes, kernel_size, stride, padding, dilation=dilation, groups=groups,
                      bias=False),
...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        self.classifier = nn.Sequential(
            nn.Dropout(0.2),
            QLinear(self.last_channel, num_classes),
        )
...
def mobilenet_v2(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MobileNetV2:
    ...
    if pretrained:
        ...
        state_dict['classifier.1.weight'] = state_dict['classifier.1.weight'][0:100, :]
        state_dict['classifier.1.bias'] = state_dict['classifier.1.bias'][0:100]
...
if __name__ == '__main__':
    # run_program()
    summary(mobilenet_v2(), torch.zeros((1, 3, 224, 224)))